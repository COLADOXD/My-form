...
<template>
  <div class="bg-white px-4 py-6 rounded-lg">
    ...
    >
      <div
        class="rounded-full bg-orange-400 h-10 w-10 flex items-center justify-center"
      >
        <svg
    ...
    >
      <div
        class="rounded-full bg-red-300 h-10 w-10 flex items-center justify-center"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    >
      <div
        class="rounded-full bg-blue-500 h-10 w-10 flex items-center justify-center"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
